...
<script type="text/javascript" src="../js/AllStudentAllExam.js"></script>
</head>
<body>
	...
	<a id='backToChartMenu' href="chartSummary.jsp">Back to Chart Menu</a>
	<div id='no-data-display' class="list-group"></div>
	<div id="chart-cdetail" data-height="260px" data-width="480px"
